...
/**
 * @summary The giveaway update payload interface.
 * @description This interface is used to update a giveaway.
 */
interface IGivewayUpdatePayload {
    /**
...
export type { IGivewayUpdatePayload }
