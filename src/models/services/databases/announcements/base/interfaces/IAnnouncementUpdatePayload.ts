...
/**
 * @summary The announcement update payload interface.
 * @description This interface is used to update an announcement.
 */
interface IAnnouncementUpdatePayload {
    /**
...
export type { IAnnouncementUpdatePayload }
